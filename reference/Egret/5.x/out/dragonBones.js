                    ...
                    for (var k in this.textures) {
                        ...
                        if (textureData.renderTexture === null) {
                            ...
                            if (textureData.rotated) {
                                textureData.renderTexture.$initData(textureData.region.x, textureData.region.y, subTextureHeight, subTextureWidth, 0, 0, subTextureHeight, subTextureWidth, textureAtlasWidth, textureAtlasHeight);
                            }
                            else {
                                textureData.renderTexture.$initData(textureData.region.x, textureData.region.y, subTextureWidth, subTextureHeight, 0, 0, subTextureWidth, subTextureHeight, textureAtlasWidth, textureAtlasHeight);
                            }
                        }
    ...
    var EgretSlot = (function (_super) {
        ...
        EgretSlot.prototype._updateMesh = function () {
            ...
            if (weightData !== null) {
                ...
                for (var i = 0, iD = 0, iB = weightData.offset + 2 /* WeigthBoneIndices */ + weightData.bones.length, iV = weightFloatOffset, iF = 0; i < vertexCount; ++i) {
